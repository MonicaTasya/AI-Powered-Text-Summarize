     ...
     <>
         <p className="mb-[5px] text-[15px] font-semibold">Masukkan teks untuk diringkas:</p>
            ...
            <div className="flex flex-col p-[10px] my-[5px] gap-[10px]">
                <button
                className="bg-cyan-400 px-[15px] rounded-md hover:bg-cyan-500 transition duration-300 xl:px-[8vw]"
                onClick={ringkasButt}>Ringkas</button>
                <button
                className="bg-cyan-400 px-[15px] rounded-md hover:bg-red-500 transition duration-300 xl:px-[8vw]"
                onClick={resetButt}>Reset</button>
            </div></div>
          <section className="mt-8 bg-white p-4 rounded-xl">
            <h2 className="text-[20px] font-bold">Hasil Ringkasan</h2>
            <p
